		...
		<div class="card">
    		...
    		<div class="col-lg-12">
    			...
    			<div class="form-group comment">
                    ...
                    <?php endif; ?>
	                <span class="float-right mr-4"><small><i>Posted at: <?php echo date('M d, Y h:i A',strtotime($row['date_created'])) ?></i></small></span>
    				...
    				<div>
    					...
    					<div class="col-lg-8 offset-lg-2 replies">
    						...
    						<div class="form-group ty-compact-list">
			                    ...
			                    <?php endif; ?>
				                <span class="float-right mr-4"><small><i>Posted at: <?php echo date('M d, Y h:i A',strtotime($rep['date_created'])) ?></i></small></span>
